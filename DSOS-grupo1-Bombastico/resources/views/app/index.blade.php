          ...
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              ...
              @foreach ($propostas as $proposta)
                @php
                // Verifique se a proposta já está atribuída ao docente
                $propostaAtribuida = \App\Models\rel_docente_proposta::where('id_proposta', $proposta->id)->exists();
                @endphp

                @unless ($propostaAtribuida)
